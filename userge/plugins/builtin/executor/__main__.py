...
@userbot.on_cmd("exec", about={
    ...
    'examples': "{tr}exec echo \"userbot\""}, allow_channels=False)
@input_checker
...
@userbot.on_cmd("eval", about={
    ...
    'examples': [
        "{tr}eval print('userbot')", "{tr}eval -s print('userbot')",
...
async def eval_(message: Message):
    ...
    _g, _l = _context(context_type, userbot=userbot,
...
@userbot.on_cmd("term", about={
    ...
    'examples': "{tr}term echo \"userbot\""}, allow_channels=False)
@input_checker
...
def _run_coro(future: asyncio.Future, coro: Awaitable[Any],
    ...
    userbot.loop.call_soon_threadsafe(
