...
from userbot.versions import get_version

CHANNEL = userbot.getCLogger(__name__)


@userbot.on_cmd("core", about={
...
@userbot.on_cmd("addrepo", about={
    ...
    'examples': [
        "{tr}addrepo https://github.com/userbotTeam/userbot-Plugins",
        "{tr}addrepo -b=master https://github.com/userbotTeam/userbot-Plugins",
        "{tr}addrepo -b=master -p=1 https://github.com/userbotTeam/userbot-Plugins"]
}, del_pre=True, allow_channels=False)
...
@userbot.on_cmd("addconsts", about={
    ...
    'examples': [
        ...
        "{tr}addconsts -type=include userbotteam.userbot-plugins/executor",
        "{tr}addconsts -type=exclude userbotteam.userbot-plugins/fun/",
        "{tr}addconsts -type=in executor help fun/ userbotteam.userbot-plugins/video_call"]
}, del_pre=True, allow_channels=False)
...
@userbot.on_cmd("rmconsts", about={
    ...
    'examples': [
        ...
        "{tr}rmconsts fun/",
        "{tr}rmconsts executor help fun/ userbotteam.userbot-plugins/video_call"]
}, del_pre=True, allow_channels=False)
...
@userbot.on_cmd("clrconsts", about={
    ...
    if updates:
        if pull_in_flags:
            ...
            if restart_in_flags:
                ...
                await userbot.restart(hard=True)
