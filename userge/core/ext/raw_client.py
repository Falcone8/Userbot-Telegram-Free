...
import userbot  # pylint: disable=unused-import

_LOG = userbot.logging.getLogger(__name__)
...
class RawClient(Client):
    ...
    def __init__(self, bot: Optional['userbot.core.client.userbotBot'] = None, **kwargs) -> None:
        self._bot = bot
        super().__init__(**kwargs)
        self._channel = userbot.core.types.new.ChannelLogger(self, "CORE")
        userbot.core.types.new.Conversation.init(self)
